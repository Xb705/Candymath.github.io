...
<html>
<head>
    <title>Candymath Unblocked</title>
    <style>
        body {
...
<body>
    ...
    Files from:
    <a href="https://docs.google.com/document/d/13KheFTNdsmeGrmt_7qUut-3ScjhGhDpeYvD5eQrztnk/edit?tab=t.0" 
        target="_blank" 
    ...
    <h2 style="color: white; text-align: center; margin-bottom: 30px; text-shadow: 2px 2px 4px rgba(0,0,0,0.3); font-weight: normal; font-size: 18px;">
    CandyMath Website:
    <a href="https://sites.google.com/students.somsd.k12.nj.us/candymath" 
        target="_blank" 
        style="display: inline; color: #79aadb; text-decoration: none; font-size: 18px; text-shadow: 1px 1px 2px rgba(0,0,0,0.2);">
        sites.google.com/candymath
    </a>
    </h2>
